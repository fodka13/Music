...
😒 **<u>القائمة السوداء في الش القروبات :</u>**
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
/blacklistchat [ايدي الش القروبات] : القائمه السداء للش القروبات من استخدام البوت.
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
/whitelistchat [ايدي الش القروبات] : القائمه البيضاء المدرجه في القائمه السوداء.
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
/blacklistedchat : لعرض القائمه السوداء في الش القروبات.
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
...
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
لاذاعة مناشير في مجموع القروبات البوت : /broadcast [بالرساله او رد على الرساله] .
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
<u>وضع الاذاعه:</u>
**-pin** : تثبيت الرساله في دردشة الخادم.
**-pinloud** : لتثبيت الرساله الخاصه بك في دردش القروبات المقدمه وارسال اشعار الى الاعضاء.

˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .

"""
HELP_5 = """😉 **<u>الاضاف القروبات في سورس وسكي :</u>**
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
/loop [ᴅɪsᴀʙʟᴇ/ᴇɴᴀʙʟᴇ] ᴏʀ [ʙᴇᴛᴡᴇᴇɴ 1:10] 
: عند التنشيط , ولكن سيتم تشغيل حلقة التشغيل الحالي في حلقة 10 مر القروبات.
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
...
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
للبحث عن كلم القروبات اغنيه : /lyrics [sᴏɴɢ ɴᴀᴍᴇ] ."""
...
HELP_8 = """💞 **<u>اوامر تشغيل القنو القروبات والمجموع القروبات:</u>**
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
للايقاف المؤقت : `وقف`
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
...
˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .
لاظهار قائمة المسار القروبات : `/queue` ."""
