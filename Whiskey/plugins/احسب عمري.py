###########
#####كود ك القروباتبة  الوسكي الليبي#####
##########
...
async def calculate_age(client:Client, message:Message):
    try:
        birth_date = datetime.datetime.strptime(message.text.split(" ")[2], "%d-%m-%Y")##### م القروباتروح تتعب بدل م القروباتخمط السورس القروبات ياخول
    except:
        await message.reply_text(f"**يا {message.from_user.mention} انت ك القروباتب الامر خطأ اكتبه هكذا (احسب عمري 1-1-2000)**")
        return
