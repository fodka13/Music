...
async def cr_source(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""** 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .**\nمرحبا بك عزيزي {message.from_user.mention}\nانا بوت الذكاء الاصطناعي الخاص بسورس وسكي \nلمعرفة الاوامر اضغط على الأزرار بالأسفل👇\n** 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "حسابي الثاني", url=f"https://t.me/BP_BP3"),
                ],[
    ...
    await message.edit_reply_markup(reply_markup=InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("|𓆩˹𓏺َِ 𓏺𝙒𝙃𝙄𝙎𝙆𓏺𝞝𝙔", url=f"https://t.me/bp_bp"),
             InlineKeyboardButton("حسابي الثاني", url=f"https://t.me/BP_BP3")],
            [InlineKeyboardButton("★ 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .⚡", url=f"https://t.me/HL_BG")],
        ]
    ))
