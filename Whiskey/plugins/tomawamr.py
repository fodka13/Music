...
async def cr_source(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""** 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .**\nمرحبا بك عزيزي {message.from_user.mention}\nهذا قسم الاوامر الخاص بسورس وسكي \nلمعرفة الاوامر اضغط على الأزرار بالأسفل👇\n** 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "اوامر  القروبات", callback_data="gr"),
                    InlineKeyboardButton(
                        "اوامر القنو القروبات", callback_data="ch"),  
                 ],[
                    InlineKeyboardButton(
...
★¦ اهلا بك عزيزي في قسم اوامر التشغيل في  القروبات
★¦ تشغيل + اسم الاغنيه
★¦ فديو + اسم الاغنيه
★¦ #فيديو + اسم الاغنيه
★¦ #فديو + اسم الاغنيه
...
async def cr_usage(_, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit_text(
        text="""** 𓏺˛ 𝙒𝙃𝙄𝙎𝙆𝙀𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 .**
★¦ اهلا بك عزيزي في قسم اوامر التشغيل في القنو القروبات
★¦ شغل + اسم الاغنيه
★¦ قناه + اسم الاغنيه
★¦ مانو + اسم الاغنيه
★¦ ق + اسم الاغنيه
