...
from Whiskey import app , Userbot
...
@app.on_message(filters.regex("^افتح  المكالمات ه$"))
async def start_group_call(c: Client, m: Message):
    ...
    if assistant is None:
        ...
        return
    msg = await app.send_message(chat_id, "جاري تشغيل  المكالمات ه..")
    try:
        ...
        await msg.edit_text("تم فتح  المكالمات ه بنجاح ⚡️~!")
...
@app.on_message(filters.regex("^اقفل  المكالمات ه$"))
async def stop_group_call(c: Client, m: Message):
    ...
    if assistant is None:
        await app.send_message(chat_id, "خطأ في المساعد")
        return
    msg = await app.send_message(chat_id, "جاري اغلاق  المكالمات ه..")
    try:
        if not (
           group_call := (
        ...
        await msg.edit_text("تم اغلاق  المكالمات ه بنجاح ⚡️~!")
