...
async def iddlock(client:Client, message:Message):
    ...
    if message.from_user.id =='6947105506':
       rotba= "مبرمج السوࢪس"
...
def call_random_member(client:Client, message:Message):
    ...
    random_member_mention = f"[{random_member.user.first_name}](tg://user?id={random_member.user.id})"
    random_message = random.choice([
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n يجب أن تحاول ثلاث مر القروبات قبل اليأس **",
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n أعطي كل يوم فرصة لتصبح أفضل يوم في حي القروباتك**",
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n لحكمة هي معرفة متى تتجاهل**",
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n الصبر هو المفتاح إلى كلَّ قفل غامض**",
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n أنت مسؤول عن م القروباتشعر به، ولكنك لست مسؤولًا عن ما يفعله الآخرون**",
         ...
         f"**-اليــك اقتبــاس اليـوـم ❤️\n│ لـ {random_member_mention}\n عندما يتغير الريح، يجب علينا أن نعدل  القروباتجاه الشراع بدلاً من أن نتوقف عن السفر**",
