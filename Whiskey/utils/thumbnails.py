...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"Whiskey/assets/Whiskey.png")
        ...
        font = ImageFont.truetype("Whiskey/assets/font2.ttf", 45)
        ImageFont.truetype("Whiskey/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Whiskey/assets/font2.ttf", 30)
        ImageFont.truetype("Whiskey/assets/font.ttf", 30)
