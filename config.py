...
PROG_ID = list(map(int, getenv("PROG_ID","6947105506").split()))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "whiskey ダ ᴍᴜsɪᴄ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6947105506").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
USER_OWNER = getenv("USER_OWNER","bp_bp")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/fodka13/Music")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "Swhiske")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Swhiske")
