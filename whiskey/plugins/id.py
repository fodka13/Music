...
async def iddlock(client:Client, message:Message):
    ...
    if message.from_user.id in whiskey:
       rotba= "مبرمج السورس"
        ...
        return await message.reply_text(f"**يا {message.from_user.mention} أمشي دور الاشراف وتعال😘😉**")    
...
async def lllock(client, message):
    ...
    if get.status in [ChatMemberStatus.ADMINISTRATOR]:
         ...
         rotba = "المالك"
    elif message.from_user.id in whiskey:
         rotba= "مبرمج السورس" 
    elif message.from_user.id in dev:
         rotba = "مطور اساسي"
...
async def idljjopen(client, message):
    ...
    if message.from_user.id in whiskey:
       rotba= "مبرمج السورس"
        ...
        await message.reply_text(f"**أمشي دور الاشراف وتعال😘😉**")   
